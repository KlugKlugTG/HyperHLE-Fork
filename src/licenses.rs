...
HyperHLE © 2023–2026 HyperHLE project contributors.
";
...
// See android/app/src/main/java/org/hyperhle/android/DocumentsProvider.kt
#[cfg(target_os = "android")]
const SKYLINE: &str = "
HyperHLE for Android incorporates code originally from the Skyline emulator
...
HyperHLE, and therefore this executable, incorporates the following Rust
...
HyperHLE, and therefore this executable, incorporates the library Dynarmic:
";
...
Dynarmic, and therefore HyperHLE, and therefore this executable, incorporates
...
HyperHLE, and therefore this executable, incorporates the library SDL 2, which
...
HyperHLE, and therefore this executable, incorporates the library OpenAL Soft,
which is available under the terms of the GNU Library Public License version 2
or any later version.
";

const STB_IMAGE: &str = "
HyperHLE, and therefore this executable, incorporates the library stb_image,
which is available either as Public Domain or under the terms of the MIT
license.
";

const PVRTD_DESCRIPTION: &str = "
HyperHLE, and therefore this executable, incorporates PVRTC decompression code
...
// When resource files are bundled with HyperHLE in such a way that the user can
...
HyperHLE executable. Please note that different licensing terms apply to source
...
// When resource files are bundled with HyperHLE in such a way that only
// HyperHLE can read the license file, use these notices.
...
This distribution of HyperHLE includes binaries for the libgcc and libstdc++
libraries from the Free Software Foundation, as originally distributed by Apple:
";

const INTERNAL_ZLIB_DYLIB_DESCRIPTION: &str = "
This distribution of HyperHLE includes binaries for zlib (libz), available under
the following license:
";

const INTERNAL_LIBERATION_FONTS_DESCRIPTION: &str = "
This distribution of HyperHLE includes Liberation Sans fonts, available under
the following license:
";

const INTERNAL_NOTO_FONTS_DESCRIPTION: &str = "
This distribution of HyperHLE includes Noto Sans CJK fonts, available under the
following license:
";
