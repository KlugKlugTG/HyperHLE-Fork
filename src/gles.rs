...
impl GLESImplementation {
    ...
    pub const GLES1_IMPLEMENTATIONS: &'static [Self] = if cfg!(target_os = "android") {
        &[Self::GLES1Native, Self::GLES1OnGLES2, Self::GLES1OnGL2]
    } else {
        &[Self::GLES1Native, Self::GLES1OnGL2]
    };
