...
* Compatibility: changes that affect which apps work in RadekHLE.
...
- New working apps:
  - [Devil May Cry 4 Refrain](https://appdb.RadekHLE.org/apps/999) (@hikari-no-yume)
  - [Amerzone Pt1](https://appdb.RadekHLE.org/apps/1091) (@ciciplusplus)
  - [Eternal Legacy](https://appdb.RadekHLE.org/apps/1107) (@ciciplusplus)
  - [Dungeon Hunter 2](https://appdb.RadekHLE.org/apps/460) (@ciciplusplus)
  - [N.O.V.A. 2: The Hero Rises Again](https://appdb.RadekHLE.org/apps/444) (@ciciplusplus)
  - [Star Battalion](https://appdb.RadekHLE.org/apps/421) (@ciciplusplus)
  - [Ice Age: Dawn of the Dinosaurs](https://appdb.RadekHLE.org/apps/60) (@ciciplusplus)
  - [Zombieville](https://appdb.RadekHLE.org/apps/1183) (@ciciplusplus)
  - [Doom Resurrection](https://appdb.RadekHLE.org/apps/278) (@ciciplusplus)
  - [Ace Combat Xi](https://appdb.RadekHLE.org/apps/195) (@alborrajo)
  - [Fruit Ninja](https://appdb.RadekHLE.org/apps/261) (@acieslewicz, @ciciplusplus)
  - [Asphalt 6](https://appdb.RadekHLE.org/apps/1217) (@ciciplusplus)
  - [World of Goo](https://appdb.RadekHLE.org/apps/1210) (@ciciplusplus)
- API support improvements:
  ...
  - Several changes have been made to fix certain apps and games that should appear in landscape, but previously were displayed stretched, cropped and/or un-rotated:
    - If an app requires a landscape orientation in the `UIInterfaceOrientation` or `UISupportedInterfaceOrientations` keys of its `Info.plist`, RadekHLE will now rotate the virtual device at startup. (@hikari-no-yume)
    - If an app overrides the `shouldAutorotateToInterfaceOrientation:` method in a `UIViewController`, and the virtual device is in a landscape orientation, RadekHLE will now apply a rotation transform to the root view when it is added to a window. (@hikari-no-yume)
  ...
  - Implicit Core Animation animations: changing an animatable `CALayer` property (`bounds`, `position`, `anchorPoint`, `opacity`, `hidden`, `backgroundColor`, `cornerRadius`) outside an explicit transaction now creates a default `CABasicAnimation` via the current `CATransaction`, while `UIView` backing layers keep implicit animations disabled so existing `UIView` animation handling is unaffected. (ported from RadekHLE)
  - Objective-C `+load` methods are now sent during class initialization, before any `+initialize`, matching the runtime's ordering guarantee. (ported from RadekHLE)
  - `NSGarbageCollector` (with `+defaultCollector` returning `nil`, as on iOS), `NSBundle` localized `.strings` loading in the standard (non-property-list) format, and `+[NSObject willChangeValueForKey:]`/`didChangeValueForKey:` integration. (ported from RadekHLE)
...
- Switch to coroutine based threading system. This solved [some compatibility issues](https://github.com/RadekHLE/RadekHLE/issues/119) and improved performance in some games. (@abnormalmaps)
...
- New working apps:
  - [Dungeon Hunter](https://appdb.RadekHLE.org/apps/313) (@ciciplusplus)
  - [Crystal Defenders: Vanguard Storm](https://appdb.RadekHLE.org/apps/100) (@ciciplusplus)
  - [Zombie Infection](https://appdb.RadekHLE.org/apps/347) (@ciciplusplus)
  - [Gangstar: West Coast Hustle](https://appdb.RadekHLE.org/apps/351) (@ciciplusplus)
  - [Asphalt 4: Elite Racing](https://appdb.RadekHLE.org/apps/96) (@ciciplusplus)
  - [Prince of Persia: Warrior Within](https://appdb.RadekHLE.org/apps/127) (@ciciplusplus)
  - [Resident Evil 4: Mobile Edition](https://appdb.RadekHLE.org/apps/91) (@alborrajo)
  - [Command & Conquer: Red Alert](https://appdb.RadekHLE.org/apps/404) (@ciciplusplus)
  - [SimCity](https://appdb.RadekHLE.org/apps/250) (@ciciplusplus)
  - [Asphalt 5](https://appdb.RadekHLE.org/apps/411) (@ciciplusplus, @hikari-no-yume)
  - [Cut the Rope](https://appdb.RadekHLE.org/apps/124) (@ciciplusplus)
  - [Skater Nation](https://appdb.RadekHLE.org/apps/424) (@ciciplusplus)
  - [Iron Man 2](https://appdb.RadekHLE.org/apps/451) (@ciciplusplus)
  - [Shrek Forever After](https://appdb.RadekHLE.org/apps/427) (@ciciplusplus)
  - [Spore Origins](https://appdb.RadekHLE.org/apps/302) (@ciciplusplus, @hikari-no-yume, @teromene)
  - [Defender Chronicles](https://appdb.RadekHLE.org/apps/267) (@hujerhoe)
  - [Real Racing](https://appdb.RadekHLE.org/apps/188) (@ciciplusplus)
  - [Tom Clancy's Splinter Cell: Conviction](https://appdb.RadekHLE.org/apps/416) (@ciciplusplus)
  - [Assassin's Creed](https://appdb.RadekHLE.org/apps/413) (@ciciplusplus)
  - [N.O.V.A. Near Orbit Vanguard Alliance](https://appdb.RadekHLE.org/apps/443) (@ciciplusplus)
  - [Brothers in Arms 2: Global Front](https://appdb.RadekHLE.org/apps/464) (@ciciplusplus)
  - [Ferrari GT: Evolution](https://appdb.RadekHLE.org/apps/116) (@ciciplusplus)
  - [Castle Frenzy](https://appdb.RadekHLE.org/apps/463) (@ciciplusplus)
  - [Hero of Sparta 2](https://appdb.RadekHLE.org/apps/453) (@ciciplusplus)
  - [Hero of Sparta](https://appdb.RadekHLE.org/apps/452) (@ciciplusplus)
  - [Bridge Odyssey](https://appdb.RadekHLE.org/apps/465) (@ciciplusplus)
  - [Terminator Salvation](https://appdb.RadekHLE.org/apps/344) (@ciciplusplus)
  - [Brothers In Arms: Hour Of Heroes](https://appdb.RadekHLE.org/apps/369) (@ciciplusplus)
  - [Crusade Of Destiny](https://appdb.RadekHLE.org/apps/792) (@ciciplusplus)
  - [Arvale](https://appdb.RadekHLE.org/apps/671) (@ciciplusplus)
  - [Battlefield: Bad Company 2](https://appdb.RadekHLE.org/apps/817) (@ciciplusplus)
  - [Ms. PAC-MAN](https://appdb.RadekHLE.org/apps/63) (@acieslewicz)
  - [Dark Nebula](https://appdb.RadekHLE.org/apps/910) (@ciciplusplus)
  - [FIFA 10](https://appdb.RadekHLE.org/apps/496) (@ciciplusplus)
  - [Crash Bandicoot Nitro Kart 2](https://appdb.RadekHLE.org/apps/670) (@ciciplusplus)
  - [Driver](https://appdb.RadekHLE.org/apps/247) (@ciciplusplus)
  - [Sacred Odyssey: Rise of Ayden](https://appdb.RadekHLE.org/apps/431) (@ciciplusplus)
  - [Nanosaur 2](https://appdb.RadekHLE.org/apps/991) (@ciciplusplus)
  - [Cro-Mag Rally](https://appdb.RadekHLE.org/apps/992) (@ciciplusplus)
  - [Bugdom 2](https://appdb.RadekHLE.org/apps/995) (@ciciplusplus)
- API support improvements:
  ...
  - Core Animation and UIKit now support affine transforms, allowing UI elements to be rotated, a feature needed by [several games](https://github.com/RadekHLE/RadekHLE/issues/388). Note however that auto-rotation is not yet supported. (@hikari-no-yume)
  - Partial support for Core Animation explicit animations has been added. (@alborrajo)
  - The libz dynamic library is now available, [compiled from source](https://github.com/RadekHLE/zlib-dylib) using a [clean open-source toolchain](https://github.com/RadekHLE/common-3.0-sdk). (@acieslewicz)
...
- The new `--disable-analog-stick-tilt-controls` option can be used to disable the use of the game controller's analog sticks for accelerometer simulation. This is useful on devices with both an integrated game controller and an integrated accelerometer, as RadekHLE by default will only use the real accelerometer if no game controller is detected. (@hikari-no-yume)
- Android builds and releases of RadekHLE now have an icon and meaningful version metadata. They also now use a different package name for preview builds versus releases, which means you can install them side-by-side. (@hikari-no-yume)
- macOS builds and releases of RadekHLE now come as an application bundle (`.app` directory) rather than as a bare “Unix executable” file. This should fix problems some users encountered with running RadekHLE outside of a terminal, and allows putting RadekHLE in the Applications folder like a normal graphical app. To support this, user data (apps, options, etc) is now stored in “Application Support” rather than the current directory, and the bundled files (fonts, dylibs, etc) are now part of the app bundle. If you prefer the old layout, you can still get it if you move all the files out of the bundle. (@hikari-no-yume)
...
- Most errors causing RadekHLE to crash now produce a graphical message box, rather than the error message only being found in the log. (@abnormalmaps)
- RadekHLE now writes log messages to a file on all platforms, not just on Android. The file has been renamed from `log.txt` to `RadekHLE_log.txt`. (@hikari-no-yume)
...
- New working apps:
  - [Rayman 2](https://appdb.RadekHLE.org/apps/279) (@ciciplusplus)
  - [Tony Hawk's Pro Skater 2](https://appdb.RadekHLE.org/apps/75) (@ciciplusplus)
  - [Earthworm Jim](https://appdb.RadekHLE.org/apps/280) (@ciciplusplus)
  - [Castle of Magic](https://appdb.RadekHLE.org/apps/281) (@ciciplusplus)
- API support improvements:
...
- There is now support for iPhone OS 3.0 apps, in addition to the existing support for iPhone OS 2.x apps:
  - Support for fat binaries has been added. RadekHLE will no longer crash when trying to run an app with both ARMv6 and ARMv7 versions, and instead will try to pick the best available option (ARMv7, or failing this, ARMv6). This improves compatibility with iPhone OS 3.0 apps, many of which use fat binaries in order to improve performance on the iPhone 3GS and iPod touch (3rd generation). (@WhatAmISupposedToPutHere)
  ...
  - RadekHLE will no longer output a warning when trying to run an app with iPhone OS 3.0 as its minimum OS version. The warning now only appears for apps requiring iPhone OS 3.1 and later. (@hikari-no-yume)
...
From this release onwards, the old list of supported apps is replaced by the crowdsourced [RadekHLE app compatibility database](https://appdb.RadekHLE.org/).
...
- New working apps:
  - [Doom](https://appdb.RadekHLE.org/apps/56) (@ciciplusplus)
  - [Doom II RPG](https://appdb.RadekHLE.org/apps/57) (@alborrajo)
  - [I Love Katamari](https://appdb.RadekHLE.org/apps/55) (@ciciplusplus)
  - [Wolfenstein RPG](https://appdb.RadekHLE.org/apps/58) (@alborrajo)
...
- The Android version of RadekHLE now has a _documents provider_. Thanks to a mere three hundred lines of boilerplate code [originally written for the emulator Skyline](https://github.com/skyline-emu/skyline/blob/dc20a615275f66bee20a4fd851ef0231daca4f14/app/src/main/java/emu/skyline/provider/DocumentsProvider.kt) (RIP), it is now possible for you, as the owner of a device running a newer Android version, to move ~~files~~ _documents_ in and out of RadekHLE's ~~directory~~ _location_ on your device with relative ease. For example, it is now possible to download an ~~.ipa file~~ _`application/octet-stream` document_ to the Downloads folder of your device, then, using an appropriate app, move this _document_ to the RadekHLE _location_. Users of normal operating systems and [older versions of Android](https://developer.android.com/about/versions/11/privacy/storage#other-apps-data) continue to be able to access a superior version of the same functionality via a so-called “file manager”. (@hikari-no-yume)
- There is now an “Open file manager” button in the app picker, to make it easier to find where RadekHLE stores your apps and settings. On most operating systems this opens the relevant directory in a file manager, and on Android it opens some sort of app for managing _documents_ in the RadekHLE _location_. (@hikari-no-yume)
- The Android version of RadekHLE now writes all log messages to a file called `log.txt`, in addition to outputting them to logcat. (@hikari-no-yume)
...
- RadekHLE is now available for Android. Only AArch64 devices are supported. (@ciciplusplus, @hikari-no-yume)

Usability:

- RadekHLE now supports real accelerometer input on devices with a built-in accelerometer, such as phones and tablets. This is only used if no game controller is connected. (@hikari-no-yume)
...
- RadekHLE now has a built-in app picker with a pretty icon grid. Specifying an app on the command line bypasses it. (@hikari-no-yume)
- The new `--button-to-touch=` option lets you map a button on your game controller to a point on the touch screen. RadekHLE also now includes default button mappings for some games. (@hikari-no-yume)
- The new `--print-fps` option lets you monitor the framerate from the console. (@hikari-no-yume)

Other:

- To assist with debugging and development, RadekHLE now has a primitive implementation of the GDB Remote Serial Protocol. GDB can connect to RadekHLE over TCP and set software breakpoints, inspect memory and registers, step or continue execution, etc. This replaces the old `--breakpoint=` option, which is now removed. (@hikari-no-yume)
- The version of SDL2 used by RadekHLE has been updated to 2.26.4. (@hikari-no-yume)
...
- Some major changes have been made to how RadekHLE interacts with graphics drivers:
  - RadekHLE can now use a native OpenGL ES 1.1 driver where available, rather than translating to OpenGL 2.1. This is configurable with the new `--gles1=` option. (@hikari-no-yume)
  ...
  Theoretically, none of these changes should affect how RadekHLE behaves for ordinary users in supported apps, but graphics drivers are inscrutable and frequently buggy beasts, so it's hard to be certain. As if to demonstrate this, these changes somehow fixed the mysterious macOS-only memory leak.
- The new `--headless` option lets you run RadekHLE with no graphical output and no input whatsoever. This is only useful for command-line apps. (@hikari-no-yume)
...
- The version of stb\_image used by RadekHLE has been updated. The new version includes a fix for a bug that caused many launch images (splash screens) and icons to fail to load. Thank you to @nothings and @rygorous who diagnosed and fixed this.
...
- Options can now be loaded from files. (@hikari-no-yume)
  - The recommended options for supported apps are now applied automatically. See the new `RadekHLE_default_options.txt` file.
  - You can put your own options in the new `RadekHLE_options.txt` file.
  - If you're a Windows user, this means that dragging and dropping an app onto `RadekHLE.exe` is now all you need to do to run an app.

Other:

- The version of dynarmic used by RadekHLE has been updated. This will fix build issues for some people. (@hikari-no-yume)
