...
The code in `integration.rs` builds `TestApp.app` and runs the CLI tests in HyperHLE. Running `cargo test` will run both these CLI tests and the unit tests written in Rust.
